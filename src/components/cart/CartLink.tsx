  ...
  return (
    ...
    >
      ...
      {isHydrated && totalItems > 0 ? (
        <span className="absolute top-0.5 right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-rose-600 px-1 text-[10px] font-semibold text-background">
          {totalItems}
        </span>
      ) : null}
    </Link>
