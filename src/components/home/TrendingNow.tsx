 ...
 * name and its own current price, see `getCategoryHighlights`) that links
 * straight to that real product's page. Stays a thin async Server
 * Component; the interactive carousel lives in `TrendingNowSection` (client).
 */
